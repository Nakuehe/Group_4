...
# Load the CSV file
students_df = pd.read_csv('2022-2023-CS162-23APCS02-Students.csv')
...
df[['StudentID', 'FullName', 'Midterm', 'Final', 'Other']].to_csv('2022-2023-CS162-23APCS02-Scoreboard.csv', index=False)
